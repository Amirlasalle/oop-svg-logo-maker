...
describe("Circle", function () {
    test("rendering the svg element of size 300x300", function () {
        const expectedEl = `<svg width="300" height="300" xmlns="http://www.w3.org/2000/svg"></svg>`
    ...
    test("Testing rendering SVG element", function () {
        const expectedEl = `<svg width="300" height="300" xmlns="http://www.w3.org/2000/svg"><text x="150" y="125" font-size="60" text-anchor="middle" fill="white">AJM</text></svg>`
        const TestSVG = new SVG()
    ...
    test("Testing shape element", function () {
        const expectedEl = `<svg width="300" height="300" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="80" fill="red" /></svg>`
